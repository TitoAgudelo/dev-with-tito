      ...
      <div className="container mx-auto px-12">
        ...
        >
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-6xl lg:leading-normal font-extrabold">
            ...
            <TypeAnimation
              sequence={[
                "Tito",
                1000,
                "Lead Software Engineer | Next.js",
                1000,
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            Engineer with 12+ years of experience building scalable full-stack and cloud solutions across
            ...
            Node.js, and GraphQL architectures
          </p>
          <div>
            <Link
              href="/#contact"
